    ...
    <div className="figma360-stage" data-node-id="1152-6342">
      <div className="figma360-scale figma360-scale--signup" style={{ '--figma360-scale': String(scale) }}>
        <div className="signup" data-name="회원가입">
          ...
          <div className="signup__line signup__line--name signup__line--idle" aria-hidden />
          <div className="signup__line signup__line--name signup__line--active" aria-hidden />
          ...
          <div className="signup__line signup__line--id signup__line--idle" aria-hidden />
          <div className="signup__line signup__line--id signup__line--active" aria-hidden />
          ...
          <div className="signup__line signup__line--email signup__line--idle" aria-hidden />
          <div className="signup__line signup__line--email signup__line--active" aria-hidden />
          ...
          <div className="signup__line signup__line--password signup__line--idle" aria-hidden />
          <div className="signup__line signup__line--password signup__line--active" aria-hidden />
          ...
          <div className="signup__line signup__line--confirm signup__line--idle" aria-hidden />
          <div className="signup__line signup__line--confirm signup__line--active" aria-hidden />
