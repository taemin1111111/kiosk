    ...
    <div className="figma360-stage">
      <div className="figma360-scale figma360-scale--signup" style={{ '--figma360-scale': String(scale) }}>
        <div className="findpw">
          ...
          <img className="findpw__line findpw__line--name" alt="" src={activeField === 'name' ? imgPasswordLineActive : imgLineIdle} />
          ...
          <img className="findpw__line findpw__line--id" alt="" src={activeField === 'id' ? imgPasswordLineActive : imgLineIdle} />
          ...
          <img className="findpw__line findpw__line--email" alt="" src={activeField === 'email' ? imgPasswordLineActive : imgLineIdle} />
